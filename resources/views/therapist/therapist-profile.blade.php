                    ...
                    <form action="#" method="POST">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <div class="col-lg-12" style="display: flex; flex-direction: row; justify-content: space-between">
                                    <img src="/{{$users->photo_path}}" alt="" style="width: 80px; height: 80px; border-radius: 100% ">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 mr-auto">
                                <a href="therapistprofile-update" class="btn btn-block btn-primary text-white py-3 px-5">Update My Profile</a>
